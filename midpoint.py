...
results = pt(["x", "True Value", "Newton's Forward", "Newton's Backward", "PCHIP", "Everett's"])

for i in range(len(targets)):
    results.add_row([targets[i], Y_true[i], Y_newton_forward[i], Y_newton_backward[i], Y_pchip[i], Y_everett[i]])
